...
You are executing the /analyze-feedback workflow: User Feedback Analysis.
...
${ARGUMENTS:-No input was provided — ask the user for: <feedback data as CSV, text, or file>.}
